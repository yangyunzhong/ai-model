...
.is-platform-rail :deep(.vben-sidebar-collapse-button) {
  display: none !important;
  color: hsl(var(--header-foreground, 0 0% 100%) / 88%);
  background: hsl(0 0% 5% / 18%);
}

.is-platform-rail :deep(.vben-sidebar-collapse-button:hover) {
