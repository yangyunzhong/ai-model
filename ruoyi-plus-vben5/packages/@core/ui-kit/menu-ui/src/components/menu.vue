...
.#{$namespace}-menu {
  ...
  &.is-platform-rail {
    &.is-vertical:not(.is-collapse) {
      --menu-background-color: hsl(var(--st-color-brand));
      --menu-item-color: hsl(var(--header-foreground, 0 0% 100%));
      --menu-item-background-color: transparent;
      --menu-item-hover-color: hsl(var(--header-foreground, 0 0% 100%));
      --menu-item-hover-background-color: hsl(0 0% 5% / 26%);
      --menu-item-active-color: hsl(var(--header-foreground, 0 0% 100%));
      --menu-item-active-background-color: hsl(0 0% 5% / 26%);
      --menu-submenu-background-color: hsl(var(--st-color-brand));
      --menu-submenu-hover-color: hsl(var(--header-foreground, 0 0% 100%));
      --menu-submenu-hover-background-color: hsl(0 0% 5% / 26%);
      --menu-submenu-active-color: hsl(var(--header-foreground, 0 0% 100%));
      --menu-submenu-active-background-color: hsl(0 0% 5% / 26%);
    ...
    &.is-vertical.is-collapse {
      --menu-background-color: hsl(var(--st-color-brand));
      --menu-font-size: 12px;
      --menu-title-width: 4.5em;
      --menu-item-icon-size: 22px;
      --menu-item-collapse-size: 72px;
      ...
      .#{$namespace}-sub-menu-content,
      .#{$namespace}-menu-item {
        min-height: var(--menu-item-collapse-size);
        padding: 8px 4px !important;
      }

      .#{$namespace}-menu-tooltip__trigger,
      .#{$namespace}-sub-menu-content.is-collapse-show-title {
        gap: 6px;
      }
      ...
      > .#{$namespace}-sub-menu:not(.is-active):hover
        div[data-state='open']
        > .#{$namespace}-sub-menu-content,
      > .#{$namespace}-sub-menu:not(.is-active):hover > .#{$namespace}-sub-menu-content,
      > .#{$namespace}-menu-item:not(.is-active):hover {
        background: hsl(0 0% 5% / 26%) !important;
      }
    }
  }

  &__popup-container.is-platform-rail {
    --menu-item-active-color: hsl(var(--st-color-brand));
    --menu-item-active-background-color: hsl(var(--st-color-fill-selected));
    --menu-submenu-active-color: hsl(var(--st-color-brand));
    --menu-submenu-active-background-color: hsl(var(--st-color-fill-selected));
    min-width: 176px;
  ...
  &__popup-container.is-platform-rail &__popup {
    padding: 8px;
    ...
    .#{$namespace}-sub-menu.is-active > .#{$namespace}-sub-menu-content
      .#{$namespace}-sub-menu-content__title,
    .#{$namespace}-menu-item.is-active .#{$namespace}-menu__icon,
    .#{$namespace}-menu-item.is-active .#{$namespace}-menu-item__content > span {
      color: hsl(var(--st-color-brand));
    }
  }
