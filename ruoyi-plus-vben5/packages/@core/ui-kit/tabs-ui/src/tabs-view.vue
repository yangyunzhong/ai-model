...
<template>
  <div class="flex h-full flex-1 overflow-hidden">
    ...
    <span
      ...
      class="flex items-center justify-center border-r px-2"
    ...
    <span
      ...
      class="flex cursor-pointer items-center justify-center border-l px-2 text-muted-foreground hover:bg-muted"
